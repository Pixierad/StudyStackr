...
-- Data integrity migration (keep in sync with migrations/20260908_data_integrity.sql).
...
-- Profile account deletion migration (keep in sync with migrations/20260908_profile_account_deletion.sql).
